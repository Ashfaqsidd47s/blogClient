...
function Settings() {
    ...
    const handelSubmit =async (e)=>{
        ...
        if(file){
            ...
            try {
                await axios.post("https://codeplayerblogs-api.cyclic.app/api/upload", data)
            } catch (err) {
                console.log(err);
            }
        }
        try {
            const res =await axios.put("https://codeplayerblogs-api.cyclic.app/api/users/" +user._id,updatedUser);
            setSuccess(true);
